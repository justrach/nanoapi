...
export fn validate_string_lengths_batch(count: u32, lengths_ptr: [*]const u32, min: u32, max: u32, results_ptr: [*]u8) void {
...
export fn validate_numbers_batch(count: u32, numbers_ptr: [*]const f64, min: f64, max: f64, results_ptr: [*]u8) void {
...
export fn validate_string_lengths_simd(strings_ptr: [*]const [*]const u8, lengths_ptr: [*]const usize, count: usize, min: usize, max: usize, results_ptr: [*]bool) void {
...
export fn validate_int_range_simd(values_ptr: [*]const i64, count: usize, min: i64, max: i64, results_ptr: [*]u8) void {
...
export fn validate_int_range_simd_i32(values_ptr: [*]const i32, count: usize, min: i32, max: i32, results_ptr: [*]u8) void {
    const values = values_ptr[0..count];
    const results = results_ptr[0..count];
...
export fn validate_user_batch_ultra(names_ptr: [*]const [*:0]const u8, emails_ptr: [*]const [*:0]const u8, ages_ptr: [*]const i64, count: usize, name_min: usize, name_max: usize, age_min: i64, age_max: i64, results_ptr: [*]u8) usize {
...
export fn validate_turbo_mode_i32(count: u32, string_lengths_ptr: [*]const u32, numbers_ptr: [*]const i32, min_len: u32, max_len: u32, min_num: i32, max_num: i32, results_ptr: [*]u8) u32 {
...
export fn validate_turbo_mode(count: u32, string_lengths_ptr: [*]const u32, numbers_ptr: [*]const i64, min_len: u32, max_len: u32, min_num: i64, max_num: i64, results_ptr: [*]u8) u32 {
    const string_lengths = string_lengths_ptr[0..count];
    const numbers = numbers_ptr[0..count];
    const results = results_ptr[0..count];
